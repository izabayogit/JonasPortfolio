...
var React = _interopRequireWildcard(__webpack_require__(7392));
...
var _react = __webpack_require__(7392);
...
exports.components={"component---cache-caches-gatsby-plugin-offline-app-shell-js":()=>__webpack_require__.e(/* import() | component---cache-caches-gatsby-plugin-offline-app-shell-js */ 306).then(__webpack_require__.bind(__webpack_require__, 1367)),"component---src-pages-404-js":()=>__webpack_require__.e(/* import() | component---src-pages-404-js */ 883).then(__webpack_require__.bind(__webpack_require__, 429)),"component---src-pages-index-js":()=>__webpack_require__.e(/* import() | component---src-pages-index-js */ 678).then(__webpack_require__.bind(__webpack_require__, 723))};
...
/* harmony export */ });
var plugins=[{name:'gatsby-plugin-google-fonts',plugin:__webpack_require__(7325),options:{"plugins":[],"fonts":["Poppins:300,400,400,700,800,900"],"display":"swap"}},{name:'gatsby-plugin-offline',plugin:__webpack_require__(8379),options:{"plugins":[]}},{name:'gatsby-plugin-react-helmet',plugin:__webpack_require__(1674),options:{"plugins":[]}}];/* global plugins */ // During bootstrap, we write requires at top of this file which looks like:
// var plugins = [
//   {
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7392);
...
const trimmedPathname=stripPrefix(pathname,decodeURIComponent("/JonasPortfolio"))// Remove any hashfragment
...
// EXTERNAL MODULE: external "C:\\Users\\user\\Documents\\projects\\Retro\\JonasPortfolio\\node_modules\\react\\index.js"
var external_C_Users_user_Documents_projects_Retro_JonasPortfolio_node_modules_react_index_js_ = __webpack_require__(7392);
var external_C_Users_user_Documents_projects_Retro_JonasPortfolio_node_modules_react_index_js_default = /*#__PURE__*/__webpack_require__.n(external_C_Users_user_Documents_projects_Retro_JonasPortfolio_node_modules_react_index_js_);
// EXTERNAL MODULE: ./node_modules/prop-types/index.js
var prop_types = __webpack_require__(5697);
var prop_types_default = /*#__PURE__*/__webpack_require__.n(prop_types);
// EXTERNAL MODULE: ./node_modules/gatsby-link/index.js
var gatsby_link = __webpack_require__(8759);
...
if(this.staticQueryDb[staticQueryHash]){const jsonPayload=this.staticQueryDb[staticQueryHash];return{staticQueryHash,jsonPayload};}return this.memoizedGet(`${"/JonasPortfolio"}/page-data/sq/d/${staticQueryHash}.json`).then(req=>{const jsonPayload=JSON.parse(req.responseText);return{staticQueryHash,jsonPayload};}).catch(()=>{throw new Error(`We couldn't load "${"/JonasPortfolio"}/page-data/sq/d/${staticQueryHash}.json"`);});})).then(staticQueryResults=>{const staticQueryResultsMap={};staticQueryResults.forEach(({staticQueryHash,jsonPayload})=>{staticQueryResultsMap[staticQueryHash]=jsonPayload;this.staticQueryDb[staticQueryHash]=jsonPayload;});return staticQueryResultsMap;});return Promise.all([componentChunkPromise,staticQueryBatchPromise]).then(([pageResources,staticQueryResults])=>{let payload;if(pageResources){payload={...pageResources,staticQueryResults};finalResult.payload=payload;emitter.emit(`onPostLoadPageResources`,{page:payload,pageResources:payload});}this.pageDb.set(pagePath,finalResult);if(finalResult.error){return{error:finalResult.error,status:finalResult.status};}return payload;})// when static-query fail to load we throw a better error
...
const prefetchPathname=loader.enqueue;const StaticQueryContext=/*#__PURE__*/external_C_Users_user_Documents_projects_Retro_JonasPortfolio_node_modules_react_index_js_default().createContext({});function StaticQueryDataRenderer({staticQueryData,data,query,render}){const finalData=data?data.data:staticQueryData[query]&&staticQueryData[query].data;return/*#__PURE__*/external_C_Users_user_Documents_projects_Retro_JonasPortfolio_node_modules_react_index_js_default().createElement((external_C_Users_user_Documents_projects_Retro_JonasPortfolio_node_modules_react_index_js_default()).Fragment,null,finalData&&render(finalData),!finalData&&/*#__PURE__*/external_C_Users_user_Documents_projects_Retro_JonasPortfolio_node_modules_react_index_js_default().createElement("div",null,"Loading (StaticQuery)"));}const StaticQuery=props=>{const{data,query,render,children}=props;return/*#__PURE__*/external_C_Users_user_Documents_projects_Retro_JonasPortfolio_node_modules_react_index_js_default().createElement(StaticQueryContext.Consumer,null,staticQueryData=>/*#__PURE__*/external_C_Users_user_Documents_projects_Retro_JonasPortfolio_node_modules_react_index_js_default().createElement(StaticQueryDataRenderer,{data:data,query:query,render:render||children,staticQueryData:staticQueryData}));};const useStaticQuery=query=>{var _context$query;if(typeof (external_C_Users_user_Documents_projects_Retro_JonasPortfolio_node_modules_react_index_js_default()).useContext!==`function`&&"production"===`development`){}const context=external_C_Users_user_Documents_projects_Retro_JonasPortfolio_node_modules_react_index_js_default().useContext(StaticQueryContext);// query is a stringified number like `3303882` when wrapped with graphql, If a user forgets
...
"use strict";
var _interopRequireDefault=__webpack_require__(5318);exports.__esModule=true;exports.withPrefix=withPrefix;exports.withAssetPrefix=withAssetPrefix;exports.navigate=exports["default"]=void 0;var _objectWithoutPropertiesLoose2=_interopRequireDefault(__webpack_require__(7316));var _assertThisInitialized2=_interopRequireDefault(__webpack_require__(1506));var _inheritsLoose2=_interopRequireDefault(__webpack_require__(5354));var _extends2=_interopRequireDefault(__webpack_require__(7154));var _propTypes=_interopRequireDefault(__webpack_require__(5697));var _react=_interopRequireDefault(__webpack_require__(7392));var _reachRouter=__webpack_require__(3631);var _parsePath=__webpack_require__(5255);exports.parsePath=_parsePath.parsePath;var _isLocalLink=__webpack_require__(3421);var _rewriteLinkPath=__webpack_require__(70);var _excluded=["to","getProps","onClick","onMouseEnter","activeClassName","activeStyle","innerRef","partiallyActive","state","replace","_location"];function withPrefix(path,prefix){var _ref,_prefix;if(prefix===void 0){prefix=getGlobalBasePrefix();}if(!(0,_isLocalLink.isLocalLink)(path)){return path;}if(path.startsWith("./")||path.startsWith("../")){return path;}var base=(_ref=(_prefix=prefix)!==null&&_prefix!==void 0?_prefix:getGlobalPathPrefix())!==null&&_ref!==void 0?_ref:"/";return""+(base!==null&&base!==void 0&&base.endsWith("/")?base.slice(0,-1):base)+(path.startsWith("/")?path:"/"+path);}// These global values are wrapped in typeof clauses to ensure the values exist.
// This is especially problematic in unit testing of this component.
var getGlobalPathPrefix=function getGlobalPathPrefix(){return  false?0:"/JonasPortfolio";};var getGlobalBasePrefix=function getGlobalBasePrefix(){return  false?0:"/JonasPortfolio";};function withAssetPrefix(path){return withPrefix(path,getGlobalPathPrefix());}var NavLinkPropTypes={activeClassName:_propTypes.default.string,activeStyle:_propTypes.default.object,partiallyActive:_propTypes.default.bool};// Set up IntersectionObserver
...
"use strict";
exports.__esModule=true;exports.isLocalLink=void 0;// Copied from https://github.com/sindresorhus/is-absolute-url/blob/3ab19cc2e599a03ea691bcb8a4c09fa3ebb5da4f/index.js
var ABSOLUTE_URL_REGEX=/^[a-zA-Z][a-zA-Z\d+\-.]*?:/;var isAbsolute=function isAbsolute(path){return ABSOLUTE_URL_REGEX.test(path);};var isLocalLink=function isLocalLink(path){if(typeof path!=="string"){return undefined;// TODO(v5): Re-Add TypeError
// throw new TypeError(`Expected a \`string\`, got \`${typeof path}\``)
}return!isAbsolute(path);};exports.isLocalLink=isLocalLink;
...
"use strict";
exports.__esModule=true;exports.parsePath=parsePath;function parsePath(path){var pathname=path||"/";var search="";var hash="";var hashIndex=pathname.indexOf("#");if(hashIndex!==-1){hash=pathname.slice(hashIndex);pathname=pathname.slice(0,hashIndex);}var searchIndex=pathname.indexOf("?");if(searchIndex!==-1){search=pathname.slice(searchIndex);pathname=pathname.slice(0,searchIndex);}return{pathname:pathname,search:search==="?"?"":search,hash:hash==="#"?"":hash};}
...
"use strict";
exports.__esModule=true;exports.rewriteLinkPath=void 0;var _utils=__webpack_require__(1122);var _applyTrailingSlashOption=__webpack_require__(4506);var _parsePath2=__webpack_require__(5255);var _isLocalLink=__webpack_require__(3421);var _=__webpack_require__(8759);// Specific import to treeshake Node.js stuff
var isAbsolutePath=function isAbsolutePath(path){return path===null||path===void 0?void 0:path.startsWith("/");};var getGlobalTrailingSlash=function getGlobalTrailingSlash(){return  true?"legacy":0;};function absolutify(path,current){// If it's already absolute, return as-is
if(isAbsolutePath(path)){return path;}return(0,_utils.resolve)(path,current);}var rewriteLinkPath=function rewriteLinkPath(path,relativeTo){if(typeof path==="number"){return path;}if(!(0,_isLocalLink.isLocalLink)(path)){return path;}var _parsePath=(0,_parsePath2.parsePath)(path),pathname=_parsePath.pathname,search=_parsePath.search,hash=_parsePath.hash;var option=getGlobalTrailingSlash();var adjustedPath=path;if(option==="always"||option==="never"){var output=(0,_applyTrailingSlashOption.applyTrailingSlashOption)(pathname,option);adjustedPath=""+output+search+hash;}return isAbsolutePath(adjustedPath)?(0,_.withPrefix)(adjustedPath):absolutify(adjustedPath,relativeTo);};exports.rewriteLinkPath=rewriteLinkPath;
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(7392);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
class HTML extends (react__WEBPACK_IMPORTED_MODULE_0___default().Component){render(){return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("html",{lang:"en"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("head",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("meta",{charSet:"utf-8"}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("meta",{name:"viewport",content:"width=device-width, initial-scale=1.0"}),this.props.headComponents,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("link",{href:"/img/favicon.ico",rel:"icon"})),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("body",{style:{padding:"0px !important"},className:"no-overflow"},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{id:"___gatsby",dangerouslySetInnerHTML:{__html:this.props.body}}),this.props.postBodyComponents));}}
...
var createNamedContext = function createNamedContext(name, defaultValue) {
  var Ctx = (0,external_C_Users_user_Documents_projects_Retro_JonasPortfolio_node_modules_react_index_js_.createContext)(defaultValue);
...
var Location = function Location(_ref) {
  ...
  return external_C_Users_user_Documents_projects_Retro_JonasPortfolio_node_modules_react_index_js_default().createElement(
    LocationContext.Consumer,
    null,
    function (context) {
      return context ? children(context) : external_C_Users_user_Documents_projects_Retro_JonasPortfolio_node_modules_react_index_js_default().createElement(
        LocationProvider,
        null,
        children
      );
...
}((external_C_Users_user_Documents_projects_Retro_JonasPortfolio_node_modules_react_index_js_default()).Component);
    ...
    function (baseContext) {
      return external_C_Users_user_Documents_projects_Retro_JonasPortfolio_node_modules_react_index_js_default().createElement(
        ...
        function (locationContext) {
          return external_C_Users_user_Documents_projects_Retro_JonasPortfolio_node_modules_react_index_js_default().createElement(RouterImpl, es_extends({}, baseContext, locationContext, props));
        }
      );
    }
  );
...
var RouterImpl = function (_React$PureComponent) {
  ...
  RouterImpl.prototype.render = function render() {
    ...
    var routes = external_C_Users_user_Documents_projects_Retro_JonasPortfolio_node_modules_react_index_js_default().Children.toArray(children).reduce(function (array, child) {
    ...
    if (match) {
      ...
      var clone = external_C_Users_user_Documents_projects_Retro_JonasPortfolio_node_modules_react_index_js_default().cloneElement(element, props, element.props.children ? external_C_Users_user_Documents_projects_Retro_JonasPortfolio_node_modules_react_index_js_default().createElement(
        Router,
      ...
      return external_C_Users_user_Documents_projects_Retro_JonasPortfolio_node_modules_react_index_js_default().createElement(
        ...
        external_C_Users_user_Documents_projects_Retro_JonasPortfolio_node_modules_react_index_js_default().createElement(
          FocusWrapper,
          wrapperProps,
          clone
        )
  ...
  return RouterImpl;
}((external_C_Users_user_Documents_projects_Retro_JonasPortfolio_node_modules_react_index_js_default()).PureComponent);
...
var FocusHandler = function FocusHandler(_ref3) {
  ...
  return external_C_Users_user_Documents_projects_Retro_JonasPortfolio_node_modules_react_index_js_default().createElement(
    ...
    function (requestFocus) {
      return external_C_Users_user_Documents_projects_Retro_JonasPortfolio_node_modules_react_index_js_default().createElement(FocusHandlerImpl, es_extends({}, domProps, {
        component: component,
...
////////////////////////////////////////////////////////////////////////////////
var forwardRef = (external_C_Users_user_Documents_projects_Retro_JonasPortfolio_node_modules_react_index_js_default()).forwardRef;
    ...
    function (_ref5) {
      ...
      return external_C_Users_user_Documents_projects_Retro_JonasPortfolio_node_modules_react_index_js_default().createElement(
        ...
        function (_ref6) {
          ...
          return external_C_Users_user_Documents_projects_Retro_JonasPortfolio_node_modules_react_index_js_default().createElement("a", es_extends({
            ref: ref || innerRef,
  ...
  return external_C_Users_user_Documents_projects_Retro_JonasPortfolio_node_modules_react_index_js_default().createElement(
    ...
    function (_ref7) {
      ...
      return external_C_Users_user_Documents_projects_Retro_JonasPortfolio_node_modules_react_index_js_default().createElement(
        ...
        null,
        function (locationContext) {
          return external_C_Users_user_Documents_projects_Retro_JonasPortfolio_node_modules_react_index_js_default().createElement(RedirectImpl, es_extends({}, locationContext, { baseuri: baseuri }, props));
        }
      );
    }
  );
...
var useLocation = function useLocation() {
  var context = (0,external_C_Users_user_Documents_projects_Retro_JonasPortfolio_node_modules_react_index_js_.useContext)(LocationContext);
...
var useNavigate = function useNavigate() {
  var context = (0,external_C_Users_user_Documents_projects_Retro_JonasPortfolio_node_modules_react_index_js_.useContext)(BaseContext);
...
var createRoute = function createRoute(basepath) {
  return function (element) {
    ...
    if (element.type === (external_C_Users_user_Documents_projects_Retro_JonasPortfolio_node_modules_react_index_js_default()).Fragment && element.props.children) {
      return external_C_Users_user_Documents_projects_Retro_JonasPortfolio_node_modules_react_index_js_default().Children.map(element.props.children, createRoute(basepath));
    }
...
var React = __webpack_require__(7392);
...
"use strict";
module.exports = require("C:\\Users\\user\\Documents\\projects\\Retro\\JonasPortfolio\\.cache\\ssr-builtin-trackers\\fs");
...
"use strict";
module.exports = require("C:\\Users\\user\\Documents\\projects\\Retro\\JonasPortfolio\\node_modules\\react-dom\\server.js");
...
"use strict";
module.exports = JSON.parse('{"polyfill":["/polyfill-28dbfa58150ea9910781.js"],"app":["/app-f26c1b533c6b0e4a9630.js"],"component---cache-caches-gatsby-plugin-offline-app-shell-js":["/component---cache-caches-gatsby-plugin-offline-app-shell-js-008391400f219130dca1.js"],"component---src-pages-404-js":["/component---src-pages-404-js-ac9f49151b2567623eec.js"],"component---src-pages-index-js":["/component---src-pages-index-js-a06553e9349124a6e239.js"]}');
...
/******/ 	(() => {
/******/ 		__webpack_require__.p = "/JonasPortfolio/";
/******/ 	})();
/******/ 	
...
/* harmony export */ });
/* global HAS_REACT_18 */const React=__webpack_require__(7392);const path=__webpack_require__(1423);const{renderToString,renderToStaticMarkup,renderToPipeableStream}=__webpack_require__(4102);const{ServerLocation,Router,isRedirect}=__webpack_require__(3631);const merge=__webpack_require__(9996);const{StaticQueryContext}=__webpack_require__(7533);const fs=__webpack_require__(1330);const{WritableAsPromise}=__webpack_require__(5897);const{RouteAnnouncerProps}=__webpack_require__(236);const{apiRunner,apiRunnerAsync}=__webpack_require__(4067);const asyncRequires=__webpack_require__(5418);const{version:gatsbyVersion}=__webpack_require__(1741);const{grabMatchParams}=__webpack_require__(9755);const chunkMapping=__webpack_require__(9804);// we want to force posix-style joins, so Windows doesn't produce backslashes for urls
const{join}=path.posix;// const testRequireError = require("./test-require-error")
// For some extremely mysterious reason, webpack adds the above module *after*
// this module so that when this code runs, testRequireError is undefined.
// So in the meantime, we'll just inline it.
const testRequireError=(moduleName,err)=>{const regex=new RegExp(`Error: Cannot find module\\s.${moduleName}`);const firstLine=err.toString().split(`\n`)[0];return regex.test(firstLine);};let Html;try{Html=__webpack_require__(6308);}catch(err){if(testRequireError(`../src/html`,err)){Html=__webpack_require__(9079);}else{throw err;}}Html=Html&&Html.__esModule?Html.default:Html;const getPageDataPath=path=>{const fixedPagePath=path===`/`?`index`:path;return join(`page-data`,fixedPagePath,`page-data.json`);};const getPageDataUrl=pagePath=>{const pageDataPath=getPageDataPath(pagePath);return`${"/JonasPortfolio"}/${pageDataPath}`;};const getStaticQueryPath=hash=>join(`page-data`,`sq`,`d`,`${hash}.json`);const getStaticQueryUrl=hash=>`${"/JonasPortfolio"}/${getStaticQueryPath(hash)}`;const getAppDataUrl=()=>`${"/JonasPortfolio"}/${join(`page-data`,`app-data.json`)}`;const createElement=React.createElement;const sanitizeComponents=components=>{const componentsArray=[].concat(components).flat(Infinity).filter(Boolean);return componentsArray.map(component=>{// Ensure manifest is always loaded from content server
