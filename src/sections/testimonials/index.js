...
import "./styles.scss";
import feedback1 from "../../../content/testimonials/testimonial-1/feedback1.jpg";
import feedback2 from "../../../content/testimonials/testimonial-2/feedback2.jpg";
            ...
            <div className="client_container">
              <div className="client">
                <div className="info">
                  ...
                  <p className="profession">{value.profession}</p> */}
                </div>
              </div>
            </div>
          </div>
